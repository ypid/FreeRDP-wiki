...
One of the advantages of cmake is that it can generate project files for a variety of IDEs, including Eclipse. Instructions on how to generate an Eclipse project can be found in the "compilation instructions":wiki/Compilation.
