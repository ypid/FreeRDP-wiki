...
This page is intended for those who wish to develop the FreeRDP Wireshark RDP protocol analyzer. If you only want to use Wireshark, you should look at the "Wireshark Usage":wiki/Wireshark-Usage page instead.
